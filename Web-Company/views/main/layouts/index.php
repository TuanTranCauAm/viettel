...
<main id="main">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-lg-6" data-aos="fade-right">
          <h4>Sáng tạo vì con người Caring Inovator</h4>
          <h5>Mỗi khách hàng là một con người – một cá thể riêng biệt, cần được tôn trọng, quan tâm và lắng nghe, thấu hiểu và phục vụ một cách riêng biệt. Liên tục đổi mới, cùng với khách hàng sáng tạo ra các sản phẩm, dịch vụ ngày càng hoàn hảo. </h5>
        </div>
  ...
  <section id="services" class="services section-bg">
    <div class="container" data-aos="fade-up">
      <a href="index.php?page=main&controller=services&action=index">
